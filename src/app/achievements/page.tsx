...
const achievements = [
  {
    ...
    items: [
      ...
      {
        company: 'Signicat',
        title: 'Signicat Security Hall of Fame',
        description: 'Recognized for discovering security vulnerability',
        year: '2025',
        link: 'https://signicat.com',
      },
      {
        company: 'Dokobit',
        title: 'Dokobit Security Acknowledgment',
        description: 'Security researcher recognition for responsible disclosure',
        year: '2025',
        link: 'https://dokobit.com',
      },
      {
        company: 'Rust',
        title: 'Rust Security Team',
    ...
    items: [
      {
        ...
        description: 'Learning and completing machines and challenges',
        year: '2025',
      },
      {
        name: 'TryHackMe',
        achievement: 'Learning Path Completed',
...
const stats = [
  { icon: Bug, value: '10+', label: 'Bugs Reported' },
  { icon: Trophy, value: '6', label: 'Hall of Fame' },
